...
\]
be a sequence of $\sigma$-algebras indexed by $\mathbb{Z}_-$. Say that $X = (X_n)_{n \leq 0}$ is a \emph{backwards martingale}\index{backwards martingale} if it is adapted, $X_n \in \mathcal{L}^1$, and
\[
